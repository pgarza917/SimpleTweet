...
<img src='https://github.com/pgarza917/SimpleTweet/blob/master/simpleTweetWalkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [Kap](https://getkap.co/).

## Notes

* Experienced some issues with loading embedded photo media from the Twitter API
* Had trouble implementing dividers between Tweets
